...
function Profile () {
  return (
    <div className="Profile">
      <div className="hero">
        <img id='profilePic' src={profilePic} alt="profil-picture" />
      </div>
      <div className="describe">
        <h1>Hi👋, Halo there!</h1>
        <p>
          I'm Mohammad Hoiruttamim, i have interest about web programming like a frontend and backend development. Another side i like workout, travelling, and cooking 
        </p>
      </div>
      <div className="tags">
        <div className="tag">
      ...
      <div className="connect">
        ...
        <div className="media">
          <div className="icon">
            <a href="https://www.instagram.com/mohd_hoiruttmim/">
              <img src={instagram} alt="instagram" className='white'/>
            </a>
            <a href="https://github.com/MohdHoiruttmim/">
              <img src={github} alt="instagram" className='white'/>
            </a>
            <a href="https://www.linkedin.com/in/mohammad-hoiruttamim-24866a208/">
              <img src={linkedin} alt="instagram" className='white'/>
            </a>
          </div>
        </div>
      </div>
